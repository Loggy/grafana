...
import { numberWithCommas, formatPercent, getPackageNameFromStackTrace, getFormatter } from './utils/format';
// import { colorBasedOnPackageName, colorGreyscale } from './utils/color';
...
class FlameGraphRenderer extends React.Component {
  ...
  componentDidMount() {
    ...
    this.rangeMax = 1;
    this.query = '';
    this.panelContainer = document.querySelector('canvas')?.closest('main');
    ...
    return (
      <>
        <div style={{ height: '100%', opacity: this.state.noData ? 0 : 1 }}>
          <>
            <div className="flamegraph-container panes-wrapper" style={{ height: '100%' }}>
